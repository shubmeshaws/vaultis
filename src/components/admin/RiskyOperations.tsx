        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between px-1">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-foreground uppercase tracking-tight">Access & Safety Audit</h3>
                </div>
            ...
            <div className="grid grid-cols-1 gap-3">
                            ...
                            <div className={`p-5 rounded-2xl bg-black/20 border backdrop-blur-md transition-all duration-300 hover:bg-white/5 flex items-center gap-6 ${op.severity === 'critical' ? 'border-red-500/30' : 'border-amber-500/30'
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-3 mb-1">
                                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold tracking-widest uppercase ${op.severity === 'critical' ? 'bg-red-500 text-white' : 'bg-amber-500 text-black'
                                            }`}>
                                            {op.type}
                                        </span>
                                ...
                                {/* Action */}
                                <button className="px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-all font-bold text-[10px] uppercase tracking-widest text-muted-foreground hover:text-foreground">
                                    View Source
                                </button>
                            </div>
                        </motion.div>
                ...
                {ops.length === 0 && (
                    <div className="py-20 flex flex-col items-center justify-center text-center space-y-4 bg-white/[0.02] border border-dashed border-white/10 rounded-3xl">
                        ...
                        <div>
                            <p className="text-sm font-bold text-emerald-500 uppercase tracking-widest">System Clear</p>
