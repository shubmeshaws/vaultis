        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0">
            <motion.div
              ...
              className="absolute top-[-10%] right-[-10%] w-[60%] h-[60%] bg-blue-500/10 rounded-full blur-[120px] mix-blend-screen opacity-50"
            />
            <motion.div
              animate={{
                scale: [1.2, 1, 1.2],
              ...
              className="absolute bottom-[-10%] left-[-10%] w-[70%] h-[70%] bg-primary/10 rounded-full blur-[140px] mix-blend-screen opacity-40"
            />
          </div>
